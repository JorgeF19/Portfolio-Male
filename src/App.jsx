      ...
      <Routes location={location} key={location.pathname}>
        <Route
          ...
          element={
            ...
            >
              <main id="mainGrid">
                <ContainerComponent id="biographyTitleContainer">
                  <h1 className="title">Biography</h1>
                </ContainerComponent>
                <div className="bio">
                  <ContainerComponent id="nameTitleContainer">
                    <h1 className="title">Marialejandra Garcia</h1>
                    <h2 className="title">Actress & Director</h2>
                  </ContainerComponent>
                  <ContainerComponent id="biographyContainer">
                    <ParagraphComponent className="biographyText">
                      Born in 2005 in Barranquilla, Colombia. Marialejandra,
                      also called “Male” by her friends, is a talented
                      audiovisual artist. She had shown her creativity and deep
                      ideas capable to get into anyone's mind . She has created
                      footage with messages that makes you meditate about life,
                      social thoughts, other ones perspective. A person who
                      searches sharing her vision about world with everyone
                    </ParagraphComponent>
                  </ContainerComponent>
                </div>

                <ContainerComponent id="profileImageContainer">
